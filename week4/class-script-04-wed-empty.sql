...
-- Ask 5: Looking at the data, we have now a doubt about the meaning of the zero values... what 
-- if most of them where supposed to be NULL?! Does it matters? write a query that would check that?
SELECT * FROM Snow_cover
    LIMIT 10;
...
-- We found out that actually at the location `sno05` of the site eaba, 0 means NULL... let's 
-- update our Snow_cover table
